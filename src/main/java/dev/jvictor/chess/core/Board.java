...
public class Board {
    ...
    Board() {
        ...
        IntStream.of(8).forEach(i -> pieces.add(Piece.fromType("P", Color.WHITE, new Position(i, 2))));
        IntStream.of(8).forEach(i -> pieces.add(Piece.fromType("P", Color.BLACK, new Position(i, 7))));
        ...
        pieces.stream().collect(Collectors.toMap(Piece::getPosition, Function.identity()));
    }
